...
games = [{'players': [{'name': 'Drew Brees', 'team': 'New Orleans'}, {'name': 'Tony Romo', 'team': 'Dallas'}, {'name': 'Mark Ingram', 'team': 'New Orleans'}, {'name': 'Joseph Randle', 'team': 'Dallas'}, {'name': 'Brandin Cooks', 'team': 'New Orleans'}, {'name': 'Jason Witten', 'team': 'Dallas'}, {'name': 'Josh Hill', 'team': 'New Orleans'}, {'name': 'Dallas'}, {'name': 'New Orleans'}], 'id': '400791720'}]
