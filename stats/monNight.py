...
games = [{'players': [{'name': 'Russell Wilson', 'team': 'Seattle'}, {'name': 'Matthew Stafford', 'team': 'Detroit'}, {'name': 'Marshawn Lynch', 'team': 'Seattle'}, {'name': 'Joique Bell', 'team': 'Detroit'}, {'name': 'Calvin Johnson', 'team': 'Detroit'}, {'name': 'Golden Tate', 'team': 'Detroit'}, {'name': 'Jimmy Graham', 'team': 'Seattle'}, {'name': 'Eric Ebron', 'team': 'Detroit'}, {'name': 'Seattle'}, {'name': 'Detroit'}], 'id': '400791741'}]
