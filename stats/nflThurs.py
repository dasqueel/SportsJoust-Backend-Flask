...
games = [{'players': [{'name': 'Ben Roethlisberger', 'team': 'Pittsburgh'}, {'name': 'Justin Forsett', 'team': 'Baltimore'}, {'name': 'Antonio Brown', 'team': 'Pittsburgh'}, {'name': 'Steve Smith', 'team': 'Baltimore'}, {'name': 'Heath Miller', 'team': 'Pittsburgh'}, {'name': 'Maxx Williams', 'team': 'Baltimore'}, {'name': 'Baltimore'}, {'name': 'Pittsburgh'}], 'id': '400791662'}]
